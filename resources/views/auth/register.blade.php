        ...
        <div class="card bg-transparent p-0 m-0 rounded-0 col-md-8 col-lg-6 col-sm-10 col-11">
            <div class="card-body rounded-0  ">
                ...
                <div class="row p-0 m-0 col-12 ">
                    ...
                    <form class="rounded-0 row p-0 m-0 col-12  justify-content-center " method="POST" id="registerForm" action="{{ route('register') }}">
                        @csrf
                        ...
                        <div class=" mb-2 col-md-6">
                            ...
                            <div class="col-md-12">
                                <input id="name" type="text" class="form-control bg-white bg-black" name="name" value="{{ old('name') }}"  autocomplete="name" autofocus>
                            </div>
                        </div>
                        ...
                        <div class=" mb-2 col-md-6">
                            ...
                            <div class="col-md-12">
                                <input id="image" type="file" class="form-control bg-white " name="profile_image" accept="image/*">
                            </div>
                        </div>
                        ...
                        <div class=" mb-2 col-md-12">
                            ...
                            <div class="col-md-12">
                                <input id="email" type="email" class="form-control bg-white " name="email" value="{{ old('email') }}"  autocomplete="email">
                            </div>
                        </div>
                        <div class=" mb-2 col-md-6">
                            ...
                            <div class="col-md-12">
                                <input id="phone_number" type="text" class="form-control bg-white " name="phone_number" value="{{ old('phone_number') }}"  autocomplete="phone_number">
                            </div>
                        </div>
                        ...
                        <div class=" mb-2 col-md-4">
                            ...
                            <div class="col-md-12">
                                <input id="country" type="text" class="form-control bg-white " name="country" value="{{ old('country') }}"  autocomplete="country">
                            </div>
                        </div>
                        <div class=" mb-2 col-md-4">
                            <label for="age"
                        ...
                        <div class=" mb-2 col-md-6">
                            ...
                            <div class="col-md-12">
                                <input id="password" type="password" class="form-control bg-white " name="password"  autocomplete="new-password">
                            </div>
                        </div>
                        ...
                        <div class=" mb-2 col-md-6">
                            ...
                            <div class="col-md-12">
                                <input id="password-confirm" type="password" class="form-control bg-white" name="password_confirmation"  autocomplete="new-password">
                            </div>
                        </div>

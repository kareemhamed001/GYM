                ...
                <div class="row justify-content-center">
                    <div class="col-xxl-5 col-xl-6 col-lg-7 col-md-7 col-sm-9 col-12 pe-3">
                                ...
                                <ul class="splide__list">
                                    ...
                                    <li class="splide__slide">
                                        <a href="{{asset($product->cover_image)}}" class="glightbox">
                                            <img style="object-fit: scale-down" alt="ecommerce"
                        ...
                        <div id="thumbnail-slider" class="splide">
                            <div class="splide__track">
                                <ul class="splide__list">
                                    <li class="splide__slide"><img style="object-fit: scale-down" alt="ecommerce"
                                                                   src="{{asset($product->cover_image)}}"></li>

                                    @foreach($product->images as $image)
                                        <li class="splide__slide"><img style="object-fit: scale-down" alt="ecommerce"
                                                                       src="{{asset($image?->image??'')}}"></li>
                                    @endforeach
                            ...
                            <form action="" id="purchaseForm">
                                    ...
                                    <div class="row size-selector mb-4">
                                        ...
                                        <div class="col-xl-3 col-lg-6 col-sm-6 align-self-center">
                                            <select class="form-select form-control-sm"
                                                    aria-label="Default select example" name="size" required>
                                ...
                                <div class="row quantity-selector mb-4">
                                    ...
                                    <div class="col-xl-6 col-lg-6 col-sm-6">
                                        <input class="form-control" id="quantityInput" type="number" value="1" min="1"
                                            ...
                                            <div class="reviews">
                                                ...
                                                <div class="stars mt-3 mb-sm-0 mb-4">
                                                    ...
                                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                                         viewBox="0 0 24 24" fill="none" stroke="currentColor"
                                                         stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
                                                         class="feather feather-star empty-star">
                                                        <polygon
                                                            points="12 2 15.09 8.26 22 9.27 17 14.14 18.18 21.02 12 17.77 5.82 21.02 7 14.14 2 9.27 8.91 8.26 12 2"></polygon>
                                                    </svg>
                                                </div>
            ...
            <div class="widget-content widget-content-area br-8    d-flex flex-row flex-nowrap overflow-auto">
                ...
                @foreach($relatedProducts as $related)
                    <div class="col-md-6 col-lg-4 col-xxl-2 col-6 px-md-1 px-1">
                        ...
                        <a class="card  style-6  text-decoration-none rounded-3 overflow-hidden" style="height: 300px"
                           href="{{url('/product',$related->id)}}">
                            ...
                            <img src="{{asset($related->cover_image)}}" class="card-img-top h-60 w-100"
